...
public class UserServiceImp implements UserService {
    ...
    public void forgotPassword(String email) {
        ...
        userRepository.save(users.get());
        mailService.sendEmail(email, "Quên mật khẩu","Cảm ơn bạn đã tin tưởng và sử dụng dịch vụ của chúng tôi:<br>" +
    ...
    public void guiYeuCauQuenMatKhau(String email) {
        ...
        mailService.sendEmail(email, "Đặt lại mật khẩu","Cảm ơn bạn đã tin tưởng và sử dụng dịch vụ của chúng tôi:<br>" +
                "Chúng tôi đã tạo một mật khẩu mới từ yêu cầu của bạn<br>" +
